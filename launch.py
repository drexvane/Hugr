"""Launcher for Cipher Modern AI Analytics Application.
...
# belong to the Cipher project. If the project inherits them, the agent
...
for _var in _CLAUDE_CODE_OWNED_ENV:
    if os.environ.pop(_var, None) is not None:
        print(f"cipher: stripped Claude-Code-owned {_var} from environment")
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("Launching Cipher Modern AI Data Analyst at http://127.0.0.1:8000")
    print("=" * 60 + "\n")
